...
from PyQt5.QtWidgets import QPushButton, QLabel, QFileDialog, QSpinBox, QDoubleSpinBox, QWidget, QScrollArea, QGraphicsOpacityEffect, QListWidget, QListView, QApplication, QLineEdit
