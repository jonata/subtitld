...
def set_stylesheet(self):
    self.setStyleSheet('''
                            ...
                            QListWidget                                 { outline: none; font-size:14px; color:rgb(106, 116, 131); border-radius: 4px; background-color: rgba(255, 255, 255, 200); padding:5px;} QListWidget::item { padding:5px; border-radius: 2px;} QListWidget::item:selected { background:rgb(184, 206, 224); color:rgb(106, 116, 131); }
