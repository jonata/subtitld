...
if os.name == 'nt':
    ...
    if sofile is None:
        if os.path.isfile(os.path.join(os.path.abspath(os.path.dirname(sys.argv[0])), 'libmpv.so.1')):
            sofile = os.path.join(os.path.abspath(os.path.dirname(sys.argv[0])), 'libmpv.so.1')
    if sofile is None:
